...
private:
    ...
    std::string data_ = "";
    static inline const std::string QUOT_ = "&quot;";
    static inline const std::string APOS_ = "&apos;";
    static inline const std::string LT_ = "&lt;";
    static inline const std::string GT_ = "&gt;";
    static inline const std::string AMP_ = "&amp;";
};
...
public:
    ...
    */
    // template <typename Obj>
    // void Add(Obj obj) {
    //     data_.emplace_back(std::make_unique<Obj>(std::move(obj)));
    // }
